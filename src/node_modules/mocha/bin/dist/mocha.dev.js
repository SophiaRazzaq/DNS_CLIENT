...
if (mochaArgs['node-option'] || Object.keys(nodeArgs).length || hasInspect) {
  ...
  var args = [].concat(nodeArgv, mochaPath, unparse(mochaArgs, {
    alias: aliases
  }));
  ...
  process.on('SIGINT', function () {
    ...
    proc.kill('SIGINT'); // if running in parallel mode, we will have a proper SIGINT handler, so the below won't
    // be needed.
