...
var debug = d.debug("mocha:parallel:worker:".concat(process.pid));
var isDebugEnabled = d.enabled("mocha:parallel:worker:".concat(process.pid));
...
var _bootstrap = function bootstrap(argv) {
  var plugins;
  return regeneratorRuntime.async(function bootstrap$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(handleRequires(argv.require, {
  ...
  return regeneratorRuntime.async(function run$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          serializedOptions = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : '{}';
        ...
        case 13:
          ...
          _context2.next = 16;
          return regeneratorRuntime.awrap(_bootstrap(opts));
...
debug('started worker process'); // for testing
