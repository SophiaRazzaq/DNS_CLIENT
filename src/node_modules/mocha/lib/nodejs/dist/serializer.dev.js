...
var _require = require('../utils'),
    type = _require.type,
    breakCircularDeps = _require.breakCircularDeps;

var _require2 = require('../errors'),
    createInvalidArgumentTypeError = _require2.createInvalidArgumentTypeError; // this is not named `mocha:parallel:serializer` because it's noisy and it's
...
function () {
  ...
  _createClass(SerializableWorkerResult, [{
    ...
    value: function create() {
      ...
      return _construct(SerializableWorkerResult, args);
    }
  }, {
    key: "deserialize",
...
function () {
  ...
  function SerializableEvent(eventName, originalValue, originalError) {
    ...
    if (originalValueType !== 'object' && originalValueType !== 'undefined') {
      throw createInvalidArgumentTypeError("Expected object but received ".concat(originalValueType), 'originalValue', 'object');
    }
    /**
     * An error, if present.
     * @memberof SerializableEvent
  ...
  _createClass(SerializableEvent, [{
    ...
    value: function serialize() {
      ...
      while (pair = pairs.shift()) {
        SerializableEvent._serialize.apply(SerializableEvent, [pairs].concat(_toConsumableArray(pair)));
      }
    ...
    value: function create() {
      ...
      return _construct(SerializableEvent, args);
    }
    /**
    ...
    key: "_serialize",
    value: function _serialize(pairs, parent, key) {
      ...
      if (_type === 'error') {
        ...
        parent[key] = value; // after this, set the result of type(value) to be `object`, and we'll throw
    ...
    value: function _deserializeObject(parent, key) {
      ...
      var value = parent[key]; // keys beginning with `$$` are converted into functions returning the value
