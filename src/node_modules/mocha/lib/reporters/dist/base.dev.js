...
var getFullErrorStack = function getFullErrorStack(err, seen) {
  ...
  if (index === -1) {
    ...
    if (err.cause) {
      seen = seen || new Set();
      seen.add(err);
      var causeStack = getFullErrorStack(err.cause, seen);
...
exports.list = function (failures) {
  ...
  failures.forEach(function (test, i) {
    ...
    var _getFullErrorStack = getFullErrorStack(err),
        message = _getFullErrorStack.message,
        msg = _getFullErrorStack.msg,
        stack = _getFullErrorStack.stack; // uncaught
