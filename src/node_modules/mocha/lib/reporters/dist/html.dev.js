...
function HTML(runner, options) {
  ...
  var progressRing = [items[0].getElementsByClassName('ring-flatlight')[0], items[0].getElementsByClassName('ring-highlight')[0]];
  ...
  function updateStats() {
    ...
    if (progressRing) {
      ...
      var highlightArc = percent * (wholeArc / 100); // The progress ring is in 2 parts, the flatlight color and highlight color.
      ...
      progressRing[0].style['stroke-dasharray'] = "0,".concat(highlightArc, "px,").concat(wholeArc, "px");
      progressRing[1].style['stroke-dasharray'] = "".concat(highlightArc, "px,").concat(wholeArc, "px");
    } // update stats
