...
exports.builder = function (yargs) {
  return yargs.options({
      ...
      coerce: function coerce(opts) {
        return list(opts).reduce(function (acc, opt) {
          ...
          if (pair.length > 2 || !pair.length) {
            throw createInvalidArgumentValueError("invalid reporter option '".concat(opt, "'"), '--reporter-option', opt, 'expected "key=value" format');
          }
    ...
    return true;
  }).middleware(function _callee(argv, yargs) {
    var plugins;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            console.error("\n".concat(symbols.error, " ").concat(ansi.red('ERROR:')), _context.t0);
            yargs.exit(1);
...
exports.handler = function _callee2(argv) {
  var mocha;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 2;
          _context2.next = 5;
          return regeneratorRuntime.awrap(runMocha(mocha, argv));
        ...
        case 7:
          ...
          console.error('\n Exception during run:', _context2.t0);
          process.exit(1);
