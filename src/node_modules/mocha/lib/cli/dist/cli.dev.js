...
exports.main = function () {
  ...
  var mochaArgs = arguments.length > 1 ? arguments[1] : undefined;
  debug('entered main with raw args', argv); // ensure we can require() from current working directory
