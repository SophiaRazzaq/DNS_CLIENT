...
function () {
  ...
  _createClass(YargsInstance, [{
    ...
    key: "usageConfiguration",
    value: function usageConfiguration(config) {
      (0, _argsert.argsert)('<object>', [config], arguments.length);
