...
function () {
  ...
  _createClass(Completion, [{
      ...
      if ((current.match(/^-/) || current === '' && completions.length === 0) && !this.previousArgHasChoices(args)) {
        ...
        Object.keys(options.key).forEach(function (key) {
          ...
          if (!isPositionalKey && !options.hiddenOptions.includes(key) && !_this2.argsContainKey(args, key, negable)) {
            _this2.completeOptionKey(key, completions, current, negable && !!options["default"][key]);
          }
        });
      }
    }
    ...
    value: function completeOptionKey(key, completions, current, negable) {
      var _a, _b, _c, _d;
      ...
      if (this.zshShell) {
        ...
        var aliasKey = (_b = (_a = this === null || this === void 0 ? void 0 : this.aliases) === null || _a === void 0 ? void 0 : _a[key]) === null || _b === void 0 ? void 0 : _b.find(function (alias) {
          var desc = descs[alias];
          return typeof desc === 'string' && desc.length > 0;
        });
        var descFromAlias = aliasKey ? descs[aliasKey] : undefined;
        var desc = (_d = (_c = descs[key]) !== null && _c !== void 0 ? _c : descFromAlias) !== null && _d !== void 0 ? _d : '';
        keyWithDesc = "".concat(key.replace(/:/g, '\\:'), ":").concat(desc.replace('__yargsString__:', '').replace(/(\r\n|\n|\r)/gm, ' '));
      }
