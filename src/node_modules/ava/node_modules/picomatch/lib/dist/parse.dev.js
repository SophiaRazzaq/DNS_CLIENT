...
var parse = function parse(input, options) {
  ...
  var tokens = [bos];
  var capture = opts.capture ? '' : '?:'; // create constants based on platform, for windows or posix

  var PLATFORM_CHARS = constants.globChars(opts.windows);
...
parse.fastpaths = function (input, options) {
  ...
  var _constants$globChars = constants.globChars(opts.windows),
