...
var addExtension = function addExtension(filename) {
  ...
  if (!(0, _path.extname)(filename)) result += ext;
  return result;
};
...
function getMatcherString(id, resolutionBase) {
  if (resolutionBase === false || (0, _path.isAbsolute)(id) || id.startsWith('*')) {
    return normalizePath(id);
  } // resolve('') is valid and will default to process.cwd()


  var basePath = normalizePath((0, _path.resolve)(resolutionBase || '')) // escape all possible (posix + win) path characters that might interfere with regex
  ...
  var getMatcher = function getMatcher(id) {
    return id instanceof RegExp ? id : {
      test: function test(what) {
        ...
        var fn = (0, _picomatch["default"])(pattern, {
          dot: true
        });
        var result = fn(what);
        return result;
