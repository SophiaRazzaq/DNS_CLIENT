...
__reExport(typescript_exports, require("./typescript.js")); // src/tsserver/common.ts
...
function startNodeSession(options, logger, cancellationToken) {
  ...
  function getGlobalTypingsCacheLocation() {
    switch (process.platform) {
      case "win32":
        {
          var basePath = process.env.LOCALAPPDATA || process.env.APPDATA || os.homedir && os.homedir() || process.env.USERPROFILE || process.env.HOMEDRIVE && process.env.HOMEPATH && (0, typescript_exports.normalizeSlashes)(process.env.HOMEDRIVE + process.env.HOMEPATH) || os.tmpdir();
  ...
  function getNonWindowsCacheLocation(platformIsDarwin) {
    ...
    var homePath = os.homedir && os.homedir() || process.env.HOME || (process.env.LOGNAME || process.env.USER) && "/".concat(usersDir, "/").concat(process.env.LOGNAME || process.env.USER) || os.tmpdir();
