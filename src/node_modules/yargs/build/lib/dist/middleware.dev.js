...
function globalMiddlewareFactory(globalMiddleware, context) {
  return function (callback) {
    ...
    (0, _argsert.argsert)('<array|function> [boolean]', [callback, applyBeforeValidation], arguments.length);
...
function applyMiddleware(argv, yargs, middlewares, beforeValidation) {
  ...
  return middlewares.reduce(function (acc, middleware) {
    ...
    if ((0, _isPromise.isPromise)(acc)) {
      ...
      if (beforeValidation && (0, _isPromise.isPromise)(result)) throw beforeValidationError;
