...
exports.addChainableMethod = addChainableMethod;
    ...
    get: function chainableMethodGetter() {
      ...
      var chainableMethodWrapper = function chainableMethodWrapper() {
        ...
        if (!(0, _flag.flag)(this, 'lockSsfi')) {
          (0, _flag.flag)(this, 'ssfi', chainableMethodWrapper);
        }
      ...
      (0, _addLengthGuard.addLengthGuard)(chainableMethodWrapper, name, true); // Use `Object.setPrototypeOf` if available
      ...
      (0, _transferFlags.transferFlags)(this, chainableMethodWrapper);
      return (0, _proxify.proxify)(chainableMethodWrapper);
    },
    configurable: true
  });
}