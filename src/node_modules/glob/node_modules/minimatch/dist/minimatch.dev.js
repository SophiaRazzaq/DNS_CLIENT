...
minimatch.defaults = function (def) {
  ...
  m.Minimatch =
  /*#__PURE__*/
  function (_orig$Minimatch) {
    _inherits(Minimatch, _orig$Minimatch);

    function Minimatch(pattern, options) {
      _classCallCheck(this, Minimatch);

      return _possibleConstructorReturn(this, _getPrototypeOf(Minimatch).call(this, pattern, ext(def, options)));
    }
      ...
      for (var i = 0, c; i < pattern.length && (c = pattern.charAt(i)); i++) {
        ...
        switch (c) {
          ...
          case '(':
            {
              ...
              patternListStack.push(plEntry); // negation is (?:(?!(?:js)(?:<rest>))[^/]*)
          ...
          case ')':
            {
              ...
              patternListStack.pop(); // closing an extglob

              clearStateChar();
              hasMagic = true;
              pl = _plEntry; // negation is (?:(?!js)[^/]*)
          ...
          case '|':
            {
              ...
              clearStateChar();
              re += '|'; // next subpattern can start with a dot?
          ...
          case ']':
            ...
            try {
              RegExp('[' + braExpEscape(charUnescape(cs)) + ']'); // looks good, finish up the class.
