...
function () {
  ...
  _createClass(TextWrapper, [{
    ...
    value: function _wrap_chunks(chunks) {
      ...
      if (this.width <= 0) {
        throw Error("invalid width ".concat(this.width, " (must be > 0)"));
      }
      ...
      while (chunks.length > 0) {
        ...
        var cur_line = [];
        var cur_len = 0; // Figure out which static string will prefix this line.
        ...
        var width = this.width - _indent.length; // First chunk on line is whitespace -- drop it, unless this
        ...
        while (chunks.length > 0) {
          var l = chunks[chunks.length - 1].length; // Can at least squeeze this chunk onto the current line.
    ...
    value: function wrap(text) {
       ...
       *  converted to space.
       */
      var chunks = this._split_chunks(text); // not implemented in js
