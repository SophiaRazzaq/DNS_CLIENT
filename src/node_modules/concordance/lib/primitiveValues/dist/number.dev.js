...
function () {
  ...
  _createClass(NumberValue, [{
    ...
    value: function formatDeep(theme) {
      var string = Object.is(this.value, -0) ? '-0' : String(this.value);
...
Object.defineProperty(NumberValue.prototype, 'isPrimitive', {
  value: true
});
Object.defineProperty(NumberValue.prototype, 'tag', {
  value: tag
});