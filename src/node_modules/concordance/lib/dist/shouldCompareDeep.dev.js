...
var argumentsObject = require('./complexValues/arguments').tag;
...
function shouldCompareDeep(result, lhs, rhs) {
  ...
  if (result !== AMBIGUOUS) return false; // Properties are only ambiguous if they have symbol keys. These properties
