...
var Readable = _stream["default"].Readable;
...
var STATUS_CODES = _http["default"].STATUS_CODES;
/**
 * Response class
 *
 * @param   Stream  body  Readable stream
...
var URL = _url["default"].URL || _whatwgUrl["default"].URL; // fix an issue where "format", "parse" aren't a named export for node <10

var parse_url = _url["default"].parse;
var format_url = _url["default"].format;
/**
...
var streamDestructionSupported = 'destroy' in _stream["default"].Readable.prototype;
/**
...
var URL$1 = _url["default"].URL || _whatwgUrl["default"].URL; // fix an issue where "PassThrough", "resolve" aren't a named export for node <10

var PassThrough$1 = _stream["default"].PassThrough;
...
function fetch(url, opts) {
  ...
  return new fetch.Promise(function (resolve, reject) {
    ...
    var send = (options.protocol === 'https:' ? _https["default"] : _http["default"]).request;
    ...
    if (parseInt(process.version.substring(1)) < 14) {
      ...
      req.on('socket', function (s) {
        s.addListener('close', function (hadError) {
          ...
          var hasDataListener = s.listenerCount('data') > 0; // if end happened before close but the socket didn't emit an error, do it now
